...
import { Plus, Trash2, Image as ImageIcon, Loader2 } from '@/components/common/Icons';
import { toast } from 'sonner';
import { SocialFeedPreviewGrid } from './social-feed/SocialFeedPreviewGrid';
...
export default function SocialFeedItemsEditor({
  ...
  return (
    <div className="border border-gray-200 dark:border-gray-800 rounded-xl p-4 bg-gray-50 dark:bg-[#0f0f1b] space-y-4">
      ...
      <SocialFeedPreviewGrid
        items={items}
        editingItemId={editingItemId}
        onEditItemSelect={handleEditItemSelect}
        onDeleteItem={handleDeleteSocialFeedItem}
      />
    </div>
  );
}
